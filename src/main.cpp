...
class Band3App : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<Band3App>(ctx);
    }

    Band3App(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "band3", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        auto log_config = rex::BuildLogConfig(
            log_file_cvar.empty() ? "band3.log" : log_file_cvar.c_str(),
            log_level_str, {});
        rex::InitLogging(log_config);
        rex::RegisterLogLevelCallback();
        REXLOG_INFO("band3 starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "band3", 1280, 720);
        if (!window_) {
...
XE_DEFINE_WINDOWED_APP(band3, Band3App::Create)
